-- Rollback for 20260707000001: restore publish_session_content_item to the
-- 20260618000001 definition (guide_photo inserts without caption). Existing
-- caption values already written to family/couples_location_photos rows are
-- left in place — they are valid data; only NEW publishes stop writing them.
