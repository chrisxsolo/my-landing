-- Rollback for 20260717000002_portrait_guide: restores the publish RPC to the
-- 20260717000001 (grad_spot_photos) definition — guide_photo again accepts
-- family/couples/grad only. The portrait_location_photos table, its data, and
-- the portrait-photos bucket are intentionally PRESERVED (drop them manually
