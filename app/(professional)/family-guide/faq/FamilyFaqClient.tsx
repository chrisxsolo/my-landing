...
// ─────────────────────────────────────────────────────────────────────────────
// FAMILY FAQ  →  soloxsnaps.com/family-guide/faq
// Family-session questions. Reuses the shared FAQ accordion + styling so it looks
// identical to the general and graduation FAQ pages.
// TO ADD/EDIT QUESTIONS: update familyFaqData.ts (also feeds the FAQPage JSON-LD).
// ─────────────────────────────────────────────────────────────────────────────
...
export default function FamilyFaqClient() {
    ...
    <main className="faq-page">
      ...
      <section className="faq-hero">
        ...
        <div className="faq-shell" style={{ position: "relative", zIndex: 1 }}>
          <Link href="/family-guide" className="faq-back">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
              <path d="M13 8H3M7 4L3 8l4 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            Family guide
          </Link>
          <p className="faq-kicker">👨‍👩‍👧 Family sessions</p>
          <h1 className="faq-hero-title">
            Family photos,<br />
            <em>your questions answered.</em>
          </h1>
          <p className="faq-hero-sub">
            Booking, session length, what to wear, kids, grandparents, delivery, and
            fall timing — all in one place. Still wondering something? The contact page is one click away.
          </p>
        ...
        <div className="faq-shell faq-cta-inner">
          <div className="faq-cta-card">
            ...
            <p className="faq-cta-sub">
              Send your date, who&rsquo;s joining, and the location you have in mind. I reply within 24 hours.
            </p>
            <div className="faq-cta-buttons">
              <Link href={FAMILY_CONTACT} className="faq-link faq-link--primary">Inquire about a session</Link>
              <Link href="/family-guide" className="faq-link faq-link--ghost">Read the family guide</Link>
              <Link href="/pricing/families" className="faq-link faq-link--ghost">See family pricing</Link>
            </div>
          </div>
        </div>
      </section>
